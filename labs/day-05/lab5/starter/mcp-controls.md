...
This starter table is **already filled**. Walk each row in class. Do **not** start an MCP server, Keycloak, or a Microsoft agent runtime.
...
Do not expose `review` as an unattended tool. Lab 5 does **not** ship a running MCP server.
