...
Official numbered checkpoints in this deck: [Exercise 3.3](../../labs/day-03/exercises/exercise-3.3-security-resilience-tests.md) and [Exercise 4.3](../../labs/day-04/lab4/starter/pipeline/OWNERSHIP.md). This README covers only the **unnumbered** activities.
