...
Official numbered checkpoints for this module: [Exercise 2.2](../../labs/day-02/exercises/exercise-2.2-event-flow.md) and [Exercise 2.3](../../labs/day-02/exercises/exercise-2.3-idempotency-dlq.md) (banking `TransactionSubmitted`).
