...
The last argument (`MD287`) is the **short folder name**. If VS Code already cloned a long folder name, follow Step 4 in [Lab 0](labs/day-00/lab0/LAB-0-GUIDE.md) (`mklink /J`). Do not keep two copies.
